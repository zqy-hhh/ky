...
const ModeSwitch = styled.div`
  ...
  display: flex;
  padding: 3px;
  border: 1px solid rgba(127, 229, 168, 0.55);
  ...
  button[aria-pressed="true"] {
    background: rgba(127, 229, 168, 0.28);
    color: #ffffff;
    box-shadow: inset 0 0 14px rgba(127, 229, 168, 0.22);
  }
...
export default function Panel() {
  ...
  const mapMode = useMapStyleStore((s) => s.mapMode);
  const setMapMode = useMapStyleStore((s) => s.setMapMode);
